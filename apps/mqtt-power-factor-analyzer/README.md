...
1. Go "Setting" , change the **DEVICE_SN**, **MQTT_USERNAME** and **MQTT_PASSWORD** to yours.

   ( [How to get the mqtt credentials from IAMMETER-Cloud](https://www.iammeter.com/blog/subscribe-real-time-energy-data-mqtt) ).

![image-20260404083551435](https://iammeterglobal.oss-accelerate.aliyuncs.com/img/image-20260404083551435.png)
